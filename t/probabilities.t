...
cmp_ok($pu->probability($redCount, $cardCount, 0, 3), 'eq', 0.1, '(2 in 5) pull 0 in 3 chances');
...
cmp_ok($pu->probability($redCount, $cardCount, 1, 2), 'eq', 0.6, '(2 in 5) pull 1 in 2 chances');
cmp_ok($pu->probability($redCount, $cardCount, 1, 3), '==', 0.6, '(2 in 5) pull 1 in 3 chances');
cmp_ok($pu->probability($redCount, $cardCount, 1, 4), 'eq', 0.4, '(2 in 5) pull 1 in 4 chances');
